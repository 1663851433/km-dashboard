...
import { Home, BarChart, Users, Settings, Power, ChevronRight } from 'lucide-react'
...
export function DashboardSidebar() {
  ...
  return (
    <TooltipProvider delayDuration={0}>
      <div 
        className={`${isExpanded ? 'w-16' : 'w-3'} bg-[#252b48] flex flex-col items-center py-4 space-y-4 relative transition-all duration-300`}
